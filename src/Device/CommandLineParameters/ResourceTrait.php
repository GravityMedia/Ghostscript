...
trait ResourceTrait
{
     ...
     *     instead maintains multiple resource directories and uses an extended method for finding resources, which is
     *     explained in "Finding PostScript Level 2 resources".
     *
     *     Due to the extended search method, Ghostscript uses GenericResourceDir only as a default directory for
     *     resources being not installed. Therefore GenericResourceDir may be considered as a place where new resources
     *     to be installed. The default implementation of the function ResourceFileName uses GenericResourceDir when
     *     (1) it is an absolute path, or (2) the resource file is absent. The extended search method does not call
     *     ResourceFileName .
     *
